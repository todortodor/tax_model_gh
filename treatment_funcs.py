...
def load_baseline(year):
    ...
    path = 'datas/OECD/yearly_CSV_agg_treated/datas'
    ...
    co2_intensity = pd.read_csv(path+year+'/co2_intensity_prod_'+year+'.csv')
    co2_prod = pd.read_csv(path+year+'/prod_CO2_'+year+'.csv')
    # labor = pd.read_csv('/Users/simonl/Documents/taff/datas/World bank/labor_force/labor.csv')
    labor = pd.read_csv('datas/World bank/labor_force/labor.csv')
